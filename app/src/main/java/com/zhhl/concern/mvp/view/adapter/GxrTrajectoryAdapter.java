 ...
 */
public class GxrTrajectoryAdapter extends BaseAdapter_NR<Parcelable, GxrTrajectoryAdapter.GxrTrajectoryViewHolder> {
    ...
    static class GxrTrajectoryViewHolder extends BaseAdapter_NR.ViewHolder {
