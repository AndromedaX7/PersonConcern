...
import com.zhhl.concern.di.component.DaggerPersonTrajectoryAnalysisComponent;
import com.zhhl.concern.di.module.PersonTrajectoryAnalysisModule;
import com.zhhl.concern.mvp.contract.PersonTrajectoryAnalysisContract;
import com.zhhl.concern.mvp.presenter.PersonTrajectoryAnalysisPresenter;
import com.zhhl.concern.mvp.view.adapter.GxclAdapter;
import com.zhhl.concern.mvp.view.adapter.GxrAdapter;
import com.zhhl.concern.mvp.view.adapter.PersonAnalysisAdapter;
import com.zhhl.concern.mvp.view.adapter.YearStringAdapter;
import com.zhhl.concern.tcp.data.GxclData;
import com.zhhl.concern.tcp.data.GxrTrajectoryActivity;
...
import static com.zhhl.concern.Conts.yearData;
...
public class PersonTrajectoryAnalysisActivity extends BaseMvpActivity<PersonTrajectoryAnalysisPresenter> implements PersonTrajectoryAnalysisContract.View {
    ...
    protected void initData() {
        ...
        createRequestDialog();
        clearAdapter();
        mPresent.getDataRangeWx(start, end);
        mPresent.getMyTrajectory(start, end);
    }

    @Override
    protected int getLayoutRes() {
        return R.layout.activity_trajectory_analysis2;
    }
    ...
    public void setGxclAdapter(GxclData o) {
        ...
        dismiss(new ArrayList(mGxclAdapter.getData()));
    }
...
//                Intent i = new Intent(PersonTrajectoryAnalysisActivity.this, CarTrajectoryAnalysis.class);
...
//                startActivity(i);
    ...
    private void invokeGx2(String start, String end) {
        switch (gx_flag) {
            ...
            case 2:
                clearAdapter();
                mPresent.getGxrTrajectory2(start, end);
                break;
            case 3:
                clearAdapter();
                mPresent.getGxclTrajectory();
                break;
            case 6:
                clearAdapter();
                mPresent.getChangQuDi(start, end);
                break;
        }
    }
...
//    @Override
    ...
    private void showUserData() {
        if (self) {
            if (mPresent.getRenkou() != null && mPresent.getRenkou().size() > 0) {
                SelfTrajectoryData.RenkouBean rk = this.mPresent.getRenkou().get(0);
                DialogUtils.create(this, R.layout.dialog_user_info_2,
                        ...
                        mPresent.getRylb(),
                        mPresent.getLadw(),
                        mPresent.getCarInfos()).show();
//                startActivity(new Intent(this, UserInfoActivity.class).putExtra("rk", rk).putExtra("carInfo", mPresent.getCarInfos()));
            }
        }
    }
