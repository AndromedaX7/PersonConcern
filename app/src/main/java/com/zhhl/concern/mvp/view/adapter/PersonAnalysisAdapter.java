...
import com.zhhl.concern.tcp.data.GuijiCQDWrapper;
 ...
 */
public class PersonAnalysisAdapter extends BaseAdapter_NR<PersonTrajectory, BaseAdapter_NR.ViewHolder> {
...
//                vh4.belongTo.setText(carInfo.getBelongTo());
    ...
    protected int getDefaultLayout() {
        return R.layout.item_trajectory2;
    }
    ...
    static class TrajectoryViewHolder extends BaseAdapter_NR.ViewHolder {
    ...
    static class TrajectoryViewHolder2 extends BaseAdapter_NR.ViewHolder {
    ...
    static class TrajectoryViewHolder3 extends BaseAdapter_NR. ViewHolder {
        @BindView(R.id.name)
        TextView name;
        @BindView(R.id.gxId)
        TextView gxId;
    ...
    static class TrajectoryViewHolder4 extends BaseAdapter_NR.ViewHolder {
