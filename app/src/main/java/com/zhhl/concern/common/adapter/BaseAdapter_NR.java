package com.zhhl.concern.common.adapter;
 ...
 */
public abstract class BaseAdapter_NR<T, VH extends BaseAdapter_NR.ViewHolder> extends android.widget.BaseAdapter {

    private Context context;
    protected ArrayList<T> data;

    public BaseAdapter_NR(ArrayList<T> data) {
